...
urlpatterns = [
    ...
    path('post/<str:slug>/update/', PostUpdate.as_view(), name='obj_update'),
    path('post/<str:slug>/delete/', PostDelete.as_view(), name='obj_delete'),
    ...
    path('tag/<str:slug>/update/', TagUpdate.as_view(), name='obj_update'),
    path('tag/<str:slug>/delete/', TagDelete.as_view(), name='obj_delete'),
